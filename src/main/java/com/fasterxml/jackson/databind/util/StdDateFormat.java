    ...
    extends DateFormat
{
    ...
    /**
     * This constant defines the date format by fang
     * 2017/05/04.
     */
    protected final static String DATE_FORMAT_STR_FANG_01 = "yyyy-MM-dd HH:mm:ss";
  ...
  //by fang
    protected final static DateFormat DATE_FORMAT_FANG_01;
    ...
    static {
         ...
         * 2017/5/12 BY fang 
         */
        DATE_FORMAT_FANG_01 = new SimpleDateFormat(DATE_FORMAT_STR_FANG_01);
        DATE_FORMAT_FANG_01.setTimeZone(DEFAULT_TIMEZONE);
    }
     ...
     * 2017/05/12 by fang
     */
    protected transient DateFormat _formatFang01;
    ...
    protected Date parseAsISO8601(String dateStr, ParsePosition pos)
    {
        ...
        } else if(len == 19){//by fang
        	df = _formatFang01;
        	if (df == null) {
                df = _formatPlain = (DateFormat) DATE_FORMAT_FANG_01.clone();
            }
        } else if (c == 'Z') {
            df = _formatISO8601_z;
            if (df == null) {
