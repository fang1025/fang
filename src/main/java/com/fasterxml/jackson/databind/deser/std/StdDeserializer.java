    ...
    implements java.io.Serializable
{
    ...
    private SimpleDateFormat sdf_yyyyMMddHHmmss = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        ...
        if (t == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                try {
					...
					try {
						return sdf_yyyyMMddHHmmss.parse(value);
					} catch (ParseException e1) {
						try {
							return sdf_yyyyMMdd.parse(value);
